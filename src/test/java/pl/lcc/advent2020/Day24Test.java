...
"wseweeenwnesenwwwswnew");
    ...
    void testAnswerZero(){
       var board =  new Day24() .new Board(List.of("e", "w", "se", "sw", "ne", "nw", "e", "w", "se", "sw", "ne", "nw"));
        assertThat(board.getAnswer()).isEqualTo(0);
    }
    ...
    void testOneTurn(){
        var day = new Day24();
        var src = Set.of(new Tile(0,0),new Tile (2,0));
        var boardAfterAnimation = day.new Animator(day. new Board(src),3).result();
        System.out.println(boardAfterAnimation.getAnswer());
    }
